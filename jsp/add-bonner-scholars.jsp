...
<title>Boner Scholars - Add </title>
...
<body>
	...
	<section id="contentWraper">
		...
		<section
			...
			<p
				style="color: brown; font-size: 18px; margin-top: 15px; margin-left: 1px; margin-bottom: 0px;">Bonner
				Scholars &#8250; Bonner Scholar Students &#8250; Add</p>
		</section>

		<section id="stuTable">


<c:url var="saveUrl" value="/bnrSchlr/addBnrScholars" />
<form:form modelAttribute="bonnerScholarsAttribute" method="POST" action="${saveUrl}">
	<table style="border: 0px solid; width: 244px; padding:0px; text-align:right; margin:17px;">
	<!--  
		<tr>
			<td><form:label path="id">BNumber:</form:label></td>
	...
	-->
		...
		<tr>
			...
			<tr>
			<td></td>
			<td><input type="submit" value="Save" style="float:right; margin-top:-7px; margin-bottom:" /></td>
		</tr>		
