...
public class BonnerScholarsDTO {

	private  Integer id;
	private String firstName;
	private String lastName;
	//private String semofentry;
	//private String semofdeprtr;
	...
	/*
	public String getSemofentry() {
		return semofentry;
	}
	public void setSemofentry(String semofentry) {
		this.semofentry = semofentry;
	}

	
	public String getSemofdeprtr() {
		return semofdeprtr;
	}

	public void setSemofdeprtr(String semofdeprtr) {
		this.semofdeprtr = semofdeprtr;
	}
*/
